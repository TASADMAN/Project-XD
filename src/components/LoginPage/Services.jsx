            ...
            <div data-aos="zoom-in" data-aos-delay="600" className=" w-full flex lg:flex-row flex-col justify-between items-center gap-10 mt-3 ">
                {
                    pricingplan.map((item,index) =>(
                        <div key={index} className=" bg-black p-10 rounded-3xl flex flex-col justify-center items-start gap-3 lg:w-[35%] w-full hover:scale-105 transition duration-300 cursor-pointer  hover:bg-gray-900 ">
                            <h1 className=" text-white text-4xl font-semibold font-ubuntu">{item.type}</h1>
