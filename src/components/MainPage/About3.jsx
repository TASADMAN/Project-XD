              ...
              <div className="p-10 text-center ">
                ...
                <div className="flex gap-3 items-center text-center  place-items-center mb-4">
                  ...
                  <div className=" items-center mb-2">
                    ...
                    />
                    <label htmlFor="option1" className="text-black group-hover:text-white">
                      1
                    </label>
                  </div>
                  <div className=" items-center mb-2">
                    <input
                      ...
                      className="text-limegreen h-4 w-4 mr-2"
                    />
                    <label htmlFor="option2" className="text-black group-hover:text-white">
                      2
                    </label>
                  </div>
                  <div className=" items-center mb-2">
