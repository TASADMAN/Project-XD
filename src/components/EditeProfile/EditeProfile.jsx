export default function EditeProfile() {
  return (
    <>
      <div className="bg-gray-950 w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
        <aside className="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
          <div className="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100 top-12 text-white">
            <h2 className="pl-3 mb-4 text-2xl font-semibold text-white">
              Settings
            </h2>
            <a
              href="#"
              className="flex items-center px-3 py-2.5 font-bold bg-white  text-limegreen border rounded-full"
            >
              Pubic Profile
            </a>
            <a
              href="#"
              className="flex items-center px-3 py-2.5 font-semibold  hover:text-limegreen hover:border hover:rounded-full"
            >
              Account Settings
            </a>
            <a
            ...
            <div className="w-full px-6 pb-8 mt-8 sm:max-w-xl sm:rounded-lg">
              ...
              <div className="grid max-w-2xl mx-auto mt-8">
                <div className="flex flex-col items-center space-y-5 sm:flex-row sm:space-y-0">
                  <img
                    className="object-cover w-40 h-40 p-1 rounded-full ring-2 ring-limegreen-300 dark:ring-limegreen"
