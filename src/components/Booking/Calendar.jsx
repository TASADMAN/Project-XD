                      ...
                      <div className=" modal-content py-5 text-center px-6 border-gray-900 flex sm:flex-row flex-col justify-between ">
                        <div className="sm:ms-7 sm:ps-5  border-gray-800 w-full sm:max-w-[15rem] mt-5 sm:mt-0">
                          ...
                          <button
                            ...
                            className="inline-flex items-center w-full py-2 px-5 me-2 justify-center text-sm font-medium  focus:outline-none  rounded-lg border border-gray-200 bg-gray-800 text-gray-400 dark:border-gray-600 dark:hover:text-whitehover:bg-gray-700"
                          >
                            <svg
                              className="h-6 w-6"
                            ...
                            <span className="me-3 ms-2">15</span>
                             คน
                          </button>
